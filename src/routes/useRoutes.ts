...
export default async function userRoutes(app: FastifyInstance) {
  ...
  app.get('/users/:userId/energyYears/:year/energyMonths/:month/energyDays/:day/energyHours', { preHandler: [app.authenticate] }, energyController.listHours);
  app.get('/users/:userId/energyYears/:year/energyMonths/:month/energyDays', { preHandler: [app.authenticate] }, energyController.listDays);
  app.get('/users/:userId/energyYears/:year/energyMonths', { preHandler: [app.authenticate] }, energyController.listMonths);
  app.get('/users/:userId/energyYears', { preHandler: [app.authenticate] }, energyController.listYears);

  app.get('/users/:userId/today', { preHandler: [app.authenticate] }, energyController.relatoryToday)
  ...
  app.get('/energyDistributors', energyController.listEnergyDistributor);
}
